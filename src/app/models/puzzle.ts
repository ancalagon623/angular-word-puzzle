...
export class Puzzle {
  ...
  /**
   * This method is called in the constructor on instantiation of the puzzle, and anytime the puzzle pieces need to be recreated from the difficulty level and the solution phrase. 
   * 
  ...
  shuffle () {
    if (!this.puzzlePieces || !this.puzzlePieces.length) {
      console.warn('No puzzle pieces to shuffle.');
      return;
    };
